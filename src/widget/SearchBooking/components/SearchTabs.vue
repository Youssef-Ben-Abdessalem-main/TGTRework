...
<template>
  <TabsList
    class="w-full rounded-tl-2xl flex justify-start bg-gradient-to-b from-gray-50 to-white h-auto p-0 overflow-x-auto flex-nowrap"
  >
    <TabsTrigger
      ...
      :class="[
        ...
        tab.value === activeTab
          ? 'border-primary text-sand-mid font-medium shadow-sm bg-gradient-to-b from-sand-mid/50 to-white'
          : '',
        tab.value === 'create_tour'
          ? 'bg-sand-mid text-white hover:bg-sand-mid/80 hover:text-white'
          : '',
        tab.value != activeTab ? '!border-sand-mid/50 !border-l-2' : '',
      ]"
    >
