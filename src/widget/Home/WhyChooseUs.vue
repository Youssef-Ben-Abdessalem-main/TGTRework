    ...
    <section id="about" class="py-20 md:py-28">
        <div class="container mx-auto px-4">
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="space-y-4">
                            <div class="rounded-2xl overflow-hidden">
                                <img src="@/assets/images/tunisian-guide-leading-tour-group-smiling.jpg" alt="Local tour guide"
                                    class="w-full h-48 object-cover" />
                            </div>
                            <div class="rounded-2xl overflow-hidden">
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSY59pv56sQtBx6uNX624gsHWXxsPx_1J8aIw&s" alt="Happy tourists"
                                    class="w-full h-64 object-cover" />
                            </div>
                        </div>
                        <div class="space-y-4 pt-8">
                            <div class="rounded-2xl overflow-hidden">
                                <img src="https://i0.wp.com/globalgrasshopper.com/wp-content/uploads/2014/02/Sidi-Bou-Said-1.jpg?resize=840%2C464&ssl=1" alt="Traditional market"
                                    class="w-full h-64 object-cover" />
                            </div>
                            <div class="rounded-2xl overflow-hidden">
                                <img src="https://dynamic-media.tacdn.com/media/photo-o/2f/a2/80/24/caption.jpg?w=2400&h=-1&s=1" alt="Beach sunset"
                                    class="w-full h-48 object-cover" />
                            </div>
                        </div>
                    </div>
                ...
                <!-- Right side - Content -->
                <div>
                    <p class="text-primary font-medium uppercase tracking-wider mb-2">Why Choose Us</p>
                    ...
                    <p class="text-muted-foreground text-lg mb-8">
                        With over 15 years of experience, we've perfected the art of creating unforgettable Tunisian
                        adventures.
                        Our team of local experts ensures every trip is authentic, safe, and tailored to your dreams.
                    </p>
